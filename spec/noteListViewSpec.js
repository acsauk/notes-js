...
var shorterString = "<ul><li><div>" + string_1.substring(0,20)
                                    + "</div></li><li><div>"
                                    + string_2.substring(0,20)
                                    + "</div></li></ul>"
...
describe( "The note list view", function() {
  ...
  it("URL is updated to note id hash when user clicks note", function() {
    setNoteListView();
    noteList.addNote("This is an example");
